 ...
 * @Last Modified time: 2023-12-01 09:20:44
 *
...
function manual_sync_menu_item_callback() {
  if ( ! apply_filters( prefix_key( 'manual_sync_allow' ), false ) ) {
    return;
  }
  ...
  echo '<div class="wrap">';
    ...
    if ( is_object( $next_run_scheduled ) ) {
      printf( '<p><b>Seuraava päivitys: </b>%1$s</p>', wp_date( 'Y-m-d H:i:s', $next_run_scheduled->timestamp ) );
    }
